...
namespace AbpToExcel.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AbpToExcelDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AbpToExcelEfCoreEntityExtensionMappings to extend the IdentityUser entity
